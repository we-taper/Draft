...
\abstract{
    ...
    of a research than of a pedagogic taste: ideas and
    methods are outlined, with reference to the published paper
    available in the corresponding slides. 
    
    This note only aims to provide a guidance to read those slides.  
    The page numbers in this note are the page numbers of
    each individual PDF, not necessarily the page numbers displayed
    on the bottom-right corner on those slides.
}
