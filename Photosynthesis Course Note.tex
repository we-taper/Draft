...
% $q$ represent the phonon vibration. Since $\Omega(Q) = \Omega(0) = 
% \frac{\partial}{\partial q}q + ...$, the linear-diagonal coupling
% is just the first.
% $\gamma_{mn}^l$, $\gamma_0$ is the energy for the phonon on the same
% site. 
