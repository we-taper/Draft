...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.2\linewidth]{pics/N6m-2.pdf}
...
\begin{figure}[H]
    ...
    have extended the range s.t. $p_x\in\{-\pi,3\pi\}$ to make the
    meaning clear.}
\end{figure}

Therefore, one may predict a pure spin-up wave transfering in the
point $p_x=0$ when $m=2$, and $p_x=\pm\pi$ when $m=2$.


    \subsection{Why I think the Lattice Model is wrong}
...
\subsection{Calculation Note unrelated to the main-subject}
