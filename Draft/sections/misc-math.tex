...
approximation/Saddle point approximation}
...
Stirling formula with the Saddle point approximation, also called Stationary
phase approximation in pp.108 of \cite{Altland2010}. 

Let us further restrict $z$ into $z\in\R$ and $z>0$, the natural logarithm $\ln(z)$ is well
defined, so we have
...
saddle point $x_0=z$. And $\frac{\dd[2]{F}}{\dd x^2}(x_0)=z/x_0^2=1/z>0$
