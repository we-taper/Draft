...
\section{Quantum Field Theory in a Nutshell}
\label{sec:Quantum_Field_Theory_in_a_Nutshell}
    \subsection{Part I: Motivition and Foundations}
    \label{sec:QFT_in_a_Nutshell.Part_I}
        \subsubsection{I:2 Path Integral Formulation of Quantum Physics}
        ...
        The mathematical rigorious aspect is often ignored.
        ...
        \paragraph{Corresponding pages in draft} pp. 1 to 3.

\section{Miscellnaneous Math}
\label{sec:Miscellnaneous_Math}
\subsection{\texorpdfstring{$\int_0^\infty \frac{\sin(x)}{x}$}{}}
From \href{http://math.stackexchange.com/questions/5248/solving-the-integral-int-0-infty-frac-sinxx-dx-frac-pi2}{Math.SE}. By Aryabhata (http://math.stackexchange.com/users/1102/aryabhata).
